      ...
      <div class="hidden bg-cover lg:block lg:w-2/3"
        ...
        <div class="flex items-center h-full px-20 bg-gray-900 bg-opacity-40">
          <div>
            ...
            <p class="max-w-xl mt-3 text-gray-300">Lorem ipsum dolor sit, amet consectetur adipisicing elit. In autem ipsa, nulla laboriosam
              dolores, repellendus perferendis libero suscipit nam temporibus molestiae</p>
          </div>
        </div>
      </div>
      ...
      <div class="flex items-center w-full max-w-md px-6 mx-auto lg:w-2/6">
        ...
        <div class="flex-1">
          ...
          <div class="text-center">
            <h2 class="text-4xl font-bold text-center text-gray-700 dark:text-white">Code Patch</h2>

            <p class="mt-3 text-gray-500 dark:text-gray-300">登录以访问您的帐户</p>
          </div>
          ...
          <div class="mt-8">
            <form>
              <div>
                ...
                <input type="email" name="email" id="email" placeholder="手机/邮箱"
            ...
            <p class="mt-6 text-sm text-center text-gray-400">还没有账户？
