    ...
    <div class="mx-auto">
      ...
      <div class="flex items-center justify-between bg-white px-4 py-6">
        ...
        <div class="flex items-center">
          ...
          <img class="ml-6 h-9 w-9 rounded-full object-cover" src="https://images.unsplash.com/photo-1633332755192-727a05c4013d?q=80&w=2080&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="profile" />
        </div>
      </div>
      <nav class="hidden">
        <a href="">
